...
GROUP='www-data'
THEME='twentytwenty'
PLUGINLIST="litespeed-cache.zip woocommerce.zip all-in-one-seo-pack.zip all-in-one-wp-migration.zip google-analytics-for-wordpress.zip jetpack.zip wp-mail-smtp.zip dologin.zip"
